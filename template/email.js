function generateHTML({ name, message, url, buttonText }) {
  let nameVol = name
  if (nameVol) {
            ...
            <table role="presentation" class="table">
              <tbody class="table-body">
                <tr class="header" align="center">
                  <td class="header-text">SKUPREME</td>
                </tr>
                <tr>
                  <td class="body">
                ...
                <tr align="center">
                  <td class="footer">
                    <table role="presentation" class="footer-table">
                      <tr align="center">
                        <td style="padding: 0">
                          <a
                            ...
                            ><font color="#393948">skupreme.com</font></a
                          >
                        </td>
                      </tr>
                      <tr align="center">
                        <td style="padding: 0">
                          <p class="footer-description">
                            Frictionless Ecommerce & Supply Chain Management
                          </p>
                        </td>
                      </tr>
                      <tr align="center">
                      ...
                      <tr align="center">
                        <td style="padding: 0">
                          <h5 class="footer-logo">SKUPREME</h5>
                        </td>
                      </tr>
                    </table>
                  </td>
